...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    {
        $error_message = '<p style="color:darkred;">Your email has been verified already or invalid authentication code. To go back to our home page.</p><p><a href="./" style="color:#167ac6;font-weight:bold;">Click here</a></p>';
    }
}
?>
